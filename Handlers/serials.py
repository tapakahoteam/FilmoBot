...
@settings.dp.callback_query_handler(serial_callback.random_serial_inline_data.filter(category="fantastic"))
...
# <<<<<<<<<<<<<<<<<< Callback action with [filtering by type=number] >>>>>>>>>>>>>>>>>>
@settings.dp.callback_query_handler(serial_callback.random_serial_inline_data.filter(category="comedy"))
...
# <<<<<<<<<<<<<<<<<< Callback action with [filtering by type=number] >>>>>>>>>>>>>>>>>>
@settings.dp.callback_query_handler(serial_callback.random_serial_inline_data.filter(category="science"))
